namespace Components.Adapters.Mui.MaterialUI
// namespace Feliz.MaterialUI // https://github.com/Shmew/Feliz.MaterialUI/blob/master/src/Feliz.MaterialUI/Bindings.fs
...
type CreateFilterOptionsOptions =
  ...
  // https://github.com/dotnet/fsharp/issues/12198
  // https://github.com/fable-compiler/Fable/issues/3248
